...
# Fedora distribution (created for 42)
...
EOF
    ...
    # Manage SELinux context, otherwise can't execute
    sudo semanage fcontext -a -t bin_t ${PYTHONDIR}/bin/python
    sudo restorecon ${PYTHONDIR}/bin/python
