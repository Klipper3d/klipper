...
#*# DO NOT EDIT THIS BLOCK OR BELOW. The content is auto-generated.
#*#
"""
...
class SaveConfig:
    ...
    def _read_config(self):
        ...
        for line in persist_config.split('\n'):
            ...
            out.append(line[4:])
        # XXX - should log persisted config
    ...
    def getsection(self, section):
        if self.fileconfig is None:
            ...
            self.fileconfig.readfp(StringIO.StringIO(autosave_config))
    ...
    def set(self, section, option, value):
        ...
        self.fileconfig.set(section, option, str(value))
        # XXX - should log changes
