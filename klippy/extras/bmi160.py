...
# Based on adxl345.py, Copyright (C) 2020-2023  Kevin O'Connor <kevin@koconnor.net>
#
...
# Poll every 50ms to prevent 1024-byte FIFO overflow at 1600Hz (9600 bytes/sec)
BATCH_UPDATES = 0.050
...
class BMI160:
    ...
    def _start_measurements(self):
        ...
        if self.bus_type == 'spi':
            self.read_reg(0x7F)
            time.sleep(0.010) # 10ms for mode switch
