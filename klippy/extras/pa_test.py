...
class PATest:
    def __init__(self, config):
        ...
        self.slow_velocity = config.getfloat('slow_velocity', 20., above=0.)
            ...
            while z < height - 0.00000001:
                ...
                for i in range(perimeters):
                    ...
                    yield 'G1 X%.3f Y%.3f E%.6f F%.f' % (
                            ...
                            x_switching_pos * extr_r, slow_velocity * 60.)
                    yield 'G1 X%.3f Y%.3f E%.6f F%.f' % (
                            ...
                            fast_velocity * 60.)
                    yield 'G1 X%.3f Y%.3f E%.6f F%.f' % (
                            origin_x - perimeter_x_offset, origin_y,
