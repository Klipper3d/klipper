...
class ManualStepper:
    def __init__(self, config):
        ...
        self.rail.setup_itersolve('cartesian_xyza_stepper_alloc', b'x')
    ...
    def do_set_position(self, setpos):
        self.rail.set_position([setpos, 0., 0., 0.])
    ...
    def get_position(self):
        return [self.rail.get_commanded_position(), 0., 0., 0., 0.]
    ...
    def calc_position(self, stepper_positions):
        return [stepper_positions[self.rail.get_name()], 0., 0., 0.]
