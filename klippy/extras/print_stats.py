...
class PrintStats:
    ...
    def note_start(self):
        ...
        self.state = "printing"
        self.printer.send_event("print_stats:start_printing")                                           # Added start printing event
        self.error_message = ""
    def note_pause(self):
        ...
        if self.state != "error":
            self.state = "paused"
            self.printer.send_event("print_stats:paused_printing")                                      # Added paused printing event
    def note_complete(self):
        self._note_finish("complete")
        self.printer.send_event("print_stats:complete_printing")                                        # Added complete printing event
    def note_error(self, message):
        self._note_finish("error", message)
    def note_cancel(self):
        self._note_finish("cancelled")
        self.printer.send_event("print_stats:cancelled_printing")                                       # Added cancel printing event
