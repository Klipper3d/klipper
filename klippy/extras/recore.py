...
class recore:
  def __init__(self, config):
    ...
    self.mcu_power_enable.setup_start_value(
        start_value=0., shutdown_value=1., is_static=False)
    ...
    if self.revision in ['A3', 'A4', 'A5', 'A6']:
        for idx in range(4):
            ...
            if gain == '1':
                ...
                pin.setup_start_value(start_value=0., shutdown_value=0., is_static=True)
            ...
            if pullup == '0':
                ...
                pin = ppins.setup_pin('digital_out', pin_name)
                pin.setup_start_value(start_value=1., shutdown_value=1., is_static=True)
