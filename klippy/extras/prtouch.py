...
class PRTouchCFG:
    def __init__(self, config):
        ...
        self.hot_max_temp = config.getfloat('s_hot_max_temp', default=180, minval=170, maxval=300)
        ...
        self.clr_noz_start_x = config.getfloat('clr_noz_start_x', default=0, minval=-5, maxval=1000)
        self.clr_noz_start_y = config.getfloat('clr_noz_start_y', default=0, minval=-5, maxval=1000)
        ...
        self.wipe_speed = config.getfloat('wipe_speed', default=10, minval=10, maxval=50)
