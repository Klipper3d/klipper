...
class LDC1612_ng:
    def __init__(self, config, sensor_type=None):
        ...
        self._batch_bulk.add_mux_endpoint("ldc1612_ng/dump_ldc1612", "sensor",
                                         self._name, {'header': hdr})
    ...
    def _build_config(self):
        ...
        self._ffreader.setup_query_command("ldc1612_ng_query_bulk_status oid=%c",
    ...
    def read_one_value(self):
        ...
        return LDC1612_ng_value(status=status,
                                freqval=lastval,
    ...
    def _process_batch(self, eventtime):
        ...
        if not samples:
            return {}
        return {'data': samples, 'errors': self._last_error_count,
