...
class ForceMove:
    def __init__(self, config):
        ...
        self.stepper_kinematics = ffi_main.gc(
            ffi_lib.cartesian_xyza_stepper_alloc(b'x'), ffi_lib.free)
        # Register commands
    ...
    def manual_move(self, stepper, dist, speed, accel=0.):
        ...
        stepper.set_position((0., 0., 0., 0.))
        axis_r, accel_t, cruise_t, cruise_v = calc_move_time(dist, speed, accel)
        print_time = toolhead.get_last_move_time()
        self.trapq_append(self.trapq, print_time, accel_t, cruise_t, accel_t,
                          0., 0., 0., 0., axis_r, 0., 0., 0., 0., cruise_v, accel)
    ...
    def cmd_SET_KINEMATIC_POSITION(self, gcmd):
        ...
        logging.info("SET_KINEMATIC_POSITION pos=%.3f,%.3f,%.3f,%.3f", x, y, z, a)
        toolhead.set_position([x, y, z, a, curpos[4]], homing_axes=(0, 1, 2, 3))
