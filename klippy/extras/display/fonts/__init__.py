...
import os
from .strategy import FontCacheBuilder, FontStrategyError, FontSourceStrategy, SwizzleStrategy 
...
class DisplayFont:
    def __init__(self, config):
        ...
        self.format = config.getchoice('format', list(DISPLAY_FONT_SourcingStrategies.keys()), default='bdf')
