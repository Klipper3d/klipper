...
class MCU_stepper:
    ...
    def set_lag_correction(self, rad_per_mm, stealthchop_lag_const,
                           linear_lag_const, velocity_smooth_time):
        ffi_main, ffi_lib = chelper.get_ffi()
        return ffi_lib.stepcorr_set_lag_correction(
                self._stepper_kinematics, rad_per_mm, stealthchop_lag_const,
                linear_lag_const, velocity_smooth_time) == 0
