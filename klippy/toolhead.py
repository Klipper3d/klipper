...
class ToolHead:
    ...
    def cmd_M204(self, params):
        ...
        if 'P' in params and 'T' in params and 'S' not in params:
            ...
            accel = min(gcode.get_float('P', params, self.max_accel, above=0.),
                        gcode.get_float('T', params, self.max_accel, above=0.))
        else:
            # Use S for accel
            accel = gcode.get_float('S', params, self.max_accel, above=0.)
