...
defs_kin_polargraph = """
    struct stepper_kinematics *polargraph_stepper_alloc(char axis);
    struct stepper_kinematics *polargraph_reverse_stepper_alloc(char axis);
"""
...
defs_all = [
    ...
    defs_kin_shaper, defs_kin_polargraph,
]
