...
SOURCE_FILES = [
    ...
    'kin_cartesian.c', 'kin_cartesian_xyza.c', 'kin_corexy.c', 'kin_corexya.c', 'kin_corexz.c', 'kin_delta.c',
...
defs_kin_corexya = """
    struct stepper_kinematics *corexya_stepper_alloc(char type);
"""
...
defs_all = [
    ...
    defs_kin_cartesian, defs_kin_cartesian_xyza, defs_kin_corexy, defs_kin_corexya, defs_kin_corexz, defs_kin_delta,
