...
The "recore" section is custom to recore boards.
It adds support for Recore boards by resetting the over current protection
(INA381) and enabling the high power section.

Furthermore, there is a programmable gain amplifier for all temperature inputs
allowing both thermistors, thermocouples and PT1000s to be used on all inputs as
well as PT100 with an external amplifier.

To use a thermistor, set the gain to 1, the pull-up to 1 and the offset to 0.

To use a thermocouple set the gain to 100, the pull-up 0 and the offset to 1.
```
[recore]
revision: A6
#   Hardware revision. A6 and A7 are supported.
# gain_t0: 1
# gain_t1: 1
# gain_t2: 1
# gain_t3: 1
#   Input section gain, values 1 or 100 are allowed.
# pullup_t0: 1
# pullup_t1: 1
# pullup_t2: 1
# pullup_t3: 1
#   Programmable 4.7 K pull-up. 0 = off, 1 = on
# offset_t0: 0
# offset_t1: 0
# offset_t2: 0
# offset_t3: 0
#   Programmable voltage offset on the input. 0 = off, 1 = on
```
### [thermocouple]

This section adds support for Type K thermocouples by measuring the voltage
generated by the thermocouple. It is assumed that there is an amplifier (with
gain 101, but it can be anything), a thermistor to give the junction temperature
where the thermistor is connected and then finally a voltage offset/bias to
allow for temperatures below the junction temperature.
```
[thermocouple]
# gain: 101.0
#   The gain that the amplifier has. For type K this will be 41 µV/°C * gain.
#   For a gain of 101 this will be 4.1 mV/°C
# offset: 0.0033
#   The voltage added to the input before the amplifier.
#   With a 3.3 V GPIO pin and a 1:1000 voltage divider,
#   this will give a 3.3 mV offset allowing for thethermocouple
#   to be 80 degrees below the junction temperature.
# adc_voltage: 3.3
#   The reference voltage of the ADC measuring the temperature.
# cj_sensor: temperature_sensor cold_junction
#   The cold junction temperature sensor. This is some temperature sensor sitting directly where the thermocouple is connected.
```
