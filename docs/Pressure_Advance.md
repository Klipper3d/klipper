...
height should be around 75% of the nozzle diameter). Ensure minimum layer
print time is set to 0. Make sure any "dynamic acceleration control" is
disabled in the slicer.
