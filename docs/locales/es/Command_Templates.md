...
printer has been in the "Printing" state (as tracked by the idle_timeout
module).
...
True if the sensor is in a triggered state.
...
The above list is subject to change - if using an attribute be sure to review
