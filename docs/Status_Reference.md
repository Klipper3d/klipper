...
- `retract_length`, `retract_speed`, `unretract_extra_length`,
  `unretract_speed`, `lift_z`: The current settings for the
  firmware_retraction module. These settings may differ from the
  config file if a `SET_RETRACTION` command alters them.
