...
// RX definitions
  ...
  #if CONFIG_ATSAMD51_SERIAL_RX_PA24 || CONFIG_ATSAMD51_SERIAL_TX_PA24 || CONFIG_USBSERIAL
    #error "The RX pin selected for the T5UID1 screen is already used"
  #endif
  ...
  #if CONFIG_ATSAMD51_SERIAL_RX_PA25 || CONFIG_ATSAMD51_SERIAL_TX_PA25 || CONFIG_USBSERIAL
    #error "The RX pin selected for the T5UID1 screen is already used"
  #endif
