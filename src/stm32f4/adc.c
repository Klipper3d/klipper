...
#include "stm32f4xx_ll_adc.h" // LL_ADC_REG_ReadConversionData12
#include "stm32f4xx_ll_gpio.h" // LL_GPIO_SetPinMode
...
gpio_adc_sample(struct gpio_adc g)
{
    ...
    if (!readb(&adc_busy)) {
        ...
        LL_ADC_SetChannelSamplingTime(ADC1, g.bit, LL_ADC_SAMPLINGTIME_15CYCLES);
